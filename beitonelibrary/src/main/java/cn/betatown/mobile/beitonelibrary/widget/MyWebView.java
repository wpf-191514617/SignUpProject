...
//        cookieManager.removeSessionCookie();//移除
        cookieManager.setCookie(url, "JSESSIONID=" + BaseApplication.getSession()+ ";Domain=www.beitone.com;Path=/");
    ...
    protected Map<String, String> getHeader() {
        ...
        head.put("Cookie", "JSESSIONID=" + jsessionid + ";Domain=www.beitone.com;Path=/");
        return head;
    }
