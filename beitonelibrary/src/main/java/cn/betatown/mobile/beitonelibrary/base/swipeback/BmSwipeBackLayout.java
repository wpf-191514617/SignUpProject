package cn.betatown.mobile.beitonelibrary.base.swipeback;
...
import cn.betatown.mobile.beitonelibrary.base.swipeback.app.BmSwipeBackListenerActivityAdapter;


public class BmSwipeBackLayout extends FrameLayout {
    /**
     ...
     */
    public static final int EDGE_LEFT = BmViewDragHelper.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = BmViewDragHelper.EDGE_RIGHT;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    public static final int EDGE_BOTTOM = BmViewDragHelper.EDGE_BOTTOM;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = BmViewDragHelper.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = BmViewDragHelper.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = BmViewDragHelper.STATE_SETTLING;
    ...
    private BmViewDragHelper mDragHelper;
    ...
    public BmSwipeBackLayout(Context context) {
        this(context, null);
    }

    public BmSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.BmSwipeBackLayoutStyle);
    }

    public BmSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = BmViewDragHelper.create(this, new ViewDragCallback());

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BmSwipeBackLayout, defStyle,
                0);

        int edgeSize = a.getDimensionPixelSize(R.styleable.BmSwipeBackLayout_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(R.styleable.BmSwipeBackLayout_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(R.styleable.BmSwipeBackLayout_shadow_left,
                R.drawable.shadow_left);
        int shadowRight = a.getResourceId(R.styleable.BmSwipeBackLayout_shadow_right,
                R.drawable.shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.BmSwipeBackLayout_shadow_bottom,
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent
                && mDragHelper.getViewDragState() != BmViewDragHelper.STATE_IDLE) {
    ...
    public void attachToActivity(Activity activity) {
        ...
        addSwipeListener(new BmSwipeBackListenerActivityAdapter(activity));
        decor.addView(this);
    }
    ...
    private class ViewDragCallback extends BmViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (mEdgeFlag == EDGE_LEFT || mEdgeFlag == EDGE_RIGHT) {
                directionCheck = !mDragHelper.checkTouchSlop(BmViewDragHelper.DIRECTION_VERTICAL, i);
            } else if (mEdgeFlag == EDGE_BOTTOM) {
                directionCheck = !mDragHelper
                        .checkTouchSlop(BmViewDragHelper.DIRECTION_HORIZONTAL, i);
