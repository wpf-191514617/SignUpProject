...
public class BmViewDragHelper {
     ...
     */
    public static BmViewDragHelper create(ViewGroup forParent, Callback cb) {
        return new BmViewDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static BmViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final BmViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private BmViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
